...
   	* @param args
	...
	String output = "F:/WatermarkImage/";
	String source = "F:/WatermarkImage/background2.jpg"; //源图片路径
	String icon = "F:/WatermarkImage/qxLogoRedWhite.png"; //覆盖图片路径
...
   */
	public static String markImageByMoreIcon(String icon,String source,String output,
			String imageName,String imageType,Integer degree) {
...
   */
	/*
  public static String markImageBySingleIcon(String icon,String source,String output,
		String imageName,String imageType,Integer degree) {
    String result = "添加图片水印出错";
    try {
    File file = new File(source);
...
   */
	...
	public static String markImageByMoreText(String source,String output,
	  			String imageName,String imageType,Color color,String word,Integer degree) {
